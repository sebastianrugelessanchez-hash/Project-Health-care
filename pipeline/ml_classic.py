...
class MLClassicModels:
    ...
    def gradient_boosting(self, X_train, y_train, X_test, params: Dict = None,
        ...
        # Use SGDRegressor which supports partial_fit for chunked training
        if tune and params:
            ...
            model = SGDRegressor(loss='squared_error', random_state=self.random_state)
            ...
            logger.info("  Using default SGDRegressor parameters")
